...
impl core::Device for Deferred {
    ...
    fn fenced_submit(
        ...
        unsafe {
            ...
            let mut staging_texture = ComPtr::create_with(|ptr| {
                device.CreateTexture2D(&staging_tex_desc, std::ptr::null(), ptr)
            }).map_err(|hr| {
            ...
            let mut render_texture = ComPtr::create_with(|ptr| {
                device.CreateTexture2D(&render_tex_desc, std::ptr::null(), ptr)
            }).map_err(|hr| {
            ...
            let mut rtv = ComPtr::create_with(|ptr| {
